...
# Add these with your other ARG/ENV declarations
ARG CLOUDINARY_API_SECRET_KEY
ENV CLOUDINARY_API_SECRET_KEY=${CLOUDINARY_API_SECRET_KEY}

# Add any other required Cloudinary variables
ARG CLOUDINARY_CLOUD_NAME
ENV CLOUDINARY_CLOUD_NAME=${CLOUDINARY_CLOUD_NAME}

ARG CLOUDINARY_PUBLIC_API_KEY
ENV CLOUDINARY_PUBLIC_API_KEY=${CLOUDINARY_PUBLIC_API_KEY}
